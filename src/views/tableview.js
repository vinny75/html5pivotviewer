...
PivotViewer.Views.TableView = PivotViewer.Views.IPivotViewerView.subClass({
    ...
    Setup: function(width, height, offsetX, offsetY, tileMaxRatio) {
        ...
        $('.pv-viewpanel').append("<div id='pv-table-loader' class='pv-loading'><span>Loading...</span></div>");
    ...
    CellClick: function(columnId, cells) {
        ...
        if (columnId == 'pv-key') {
            ...
            $.publish("/PivotViewer/Views/Item/Filtered", [{
                Facet: cells[1].textContent.trim(),
                    ...
                    if (showAllFacets || selectedFacet == 'Description') {
                        ...
                        if (this.tiles[j].facetItem.Description) {
                            ...
                            if (this.tiles[j].facetItem.Href) {
                                tableRows.push({
                                    key: sortKeyValue,
                                    value: "<tr class='pv-tableview-" + oddOrEven + "'><td id='pv-key' title='Toggle item selection' style='color:#009933;cursor:pointer'>" + entity + " " + "<a href=" + this.tiles[j].facetItem.Href.replace(/'/g, "%27") + " target=\"_blank\"><img style='cursor:default;' id='pv-linkout' title='Follow the link' title='Follow the link' src='images/goout.gif'></img></a></a></td><td id='pv-facet' title='Show only this predicate' style='color:#009933;cursor:pointer'>Description</td><td id='pv-value'>" + this.tiles[j].facetItem.Description + "</td></tr>"
                                });
                            } else {
                                tableRows.push({
                                    key: sortKeyValue,
                                    value: "<tr class='pv-tableview-" + oddOrEven + "'><td id='pv-key' class='tooltip' title='Toggle item selection'>" + entity + "</td><td id='pv-facet' title='Show only this predicate' style='color:#009933;cursor:pointer'>Description</td><td id='pv-value'>" + this.tiles[j].facetItem.Description + "</td></tr>"
                                });
                            }
                                ...
                                if (this.IsFilterVisible(attribute)) {
                                    ...
                                    if (this.tiles[j].facetItem.Href) {
                                        ...
                                        if (this.IsUri(value)) {
                                            tableRows.push({
                                                key: sortKeyValue,
                                                value: "<tr class='pv-tableview-" + oddOrEven + "'><td id='pv-key' title='Toggle item selection'>" + entity + "</td><td id='pv-facet'  title='Show only this predicate' style='color:#009933;cursor:pointer'>" + attribute + "</td><td id='pv-value' title='Filter on this value' style='color:#009933;cursor:pointer'>" + value + " " + "<a href=" + value + " target=\"_blank\"><img style='cursor:default;' id=pv-linkout' title='Follow the link' src='images/goout.gif'></img></a></td></tr>"
                                            });
                                        } else {
                                            tableRows.push({
                                                key: sortKeyValue,
                                                value: "<tr class='pv-tableview-" + oddOrEven + "'><td id='pv-key' title='Toggle item selection'>" + entity + "</td><td id='pv-facet'  title='Show only this predicate' style='color:#009933;cursor:pointer'>" + attribute + "</td><td id='pv-value'  title='Filter on this value' style='color:#009933;cursor:pointer'>" + value + "</td></tr>"
                                            });
                                        }
                                    }
                                } else {
                                    ...
                                    if (this.tiles[j].facetItem.Href) {
                                        ...
                                        if (this.IsUri(value)) {
                                            tableRows.push({
                                                key: sortKeyValue,
                                                value: "<tr class='pv-tableview-" + oddOrEven + "'><td id='pv-key' title='Select this value'>" + entity + "</td><td id='pv-facet' title='Show only this predicate' style='color:#009933;cursor:pointer'>" + attribute + "</td><td id='pv-value'><a href" + value + ">" + value + "</a></td></tr>"
                                            });
                                        } else {
                                            tableRows.push({
                                                key: sortKeyValue,
                                                value: "<tr class='pv-tableview-" + oddOrEven + "'><td id='pv-key' title='Select this value'>" + entity + "</td><td id='pv-facet' title='Show only this predicate' style='color:#009933;cursor:pointer'>" + attribute + "</td><td id='pv-value'>" + value + "</td></tr>"
                                            });
                                        }
                                    }
                                }
                                    ...
                                    if (this.IsFilterVisible(attribute)) {
                                        ...
                                        if (this.tiles[j].facetItem.Href) {
                                            ...
                                            if (this.IsUri(value)) {
                                                tableRows.push({
                                                    key: sortKeyValue,
                                                    value: "<tr class='pv-tableview-" + oddOrEven + "'><td id='pv-key' title='Toggle item selection'>" + entity + "</td><td id='pv-facet' class-'tooltipcustom' title='Clear predicate selection' style='color:#009933;cursor:pointer'>" + attribute + "</td><td id='pv-value' title='Filter on this value' style='color:#009933;cursor:pointer'>" + value + " " + "<a href=" + value + " target=\"_blank\"><img style='cursor:default;' id=pv-linkout' title='Follow the link' src='images/goout.gif'></img></a></td></tr>"
                                                });
                                            } else {
                                                tableRows.push({
                                                    key: sortKeyValue,
                                                    value: "<tr class='pv-tableview-" + oddOrEven + "'><td id='pv-key' title='Toggle item selection'>" + entity + "</td><td id='pv-facet' class-'tooltipcustom' title='Clear predicate selection' style='color:#009933;cursor:pointer'>" + attribute + "</td><td id='pv-value' title='Filter on this value' style='color:#009933;cursor:pointer'>" + value + "</td></tr>"
                                                });
                                            }
                                        }
                                    } else {
                                        ...
                                        if (this.tiles[j].facetItem.Href) {
                                            ...
                                            if (this.IsUri(value)) {
                                                tableRows.push({
                                                    key: sortKeyValue,
                                                    value: "<tr class='pv-tableview-" + oddOrEven + "'><td id='pv-key' title='Click the cell to select this item' style='color:#009933;cursor:pointer'>" + entity + " " + "<a href=" + this.tiles[j].facetItem.Href.replace(/'/g, "%27") + " target=\"_blank\"><img style='cursor:default;' id='pv-linkout' title='Follow the link' src='images/goout.gif'></img></a></td><td id='pv-facet' title='Clear predicate selection' style='color:#009933;cursor:pointer'>" + attribute + "</td><td id='pv-value'><a href=" + value + ">" + value + "</a></td></tr>"
                                                });
                                            } else {
                                                tableRows.push({
                                                    key: sortKeyValue,
                                            ...
                                            if (this.IsUri(value)) {
                                                tableRows.push({
                                                    key: sortKeyValue,
                                                    value: "<tr class='pv-tableview-" + oddOrEven + "'><td id='pv-key' title='Toggle item selection'>" + entity + "</td><td id='pv-facet' class-'tooltipcustom' title='Clear predicate selection' style='color:#009933;cursor:pointer'>" + attribute + "</td><td id='pv-value'><a href" + value + ">" + value + "</a></td></tr>"
                                                });
                                            } else {
                                                tableRows.push({
                                                    key: sortKeyValue,
                                                    value: "<tr class='pv-tableview-" + oddOrEven + "'><td id='pv-key' title='Toggle item selection'>" + entity + "</td><td id='pv-facet' class-'tooltipcustom' title='Clear predicate selection' style='color:#009933;cursor:pointer'>" + attribute + "</td><td id='pv-value'>" + value + "</td></tr>"
                                                });
                                            }
                                        }
                                    }
